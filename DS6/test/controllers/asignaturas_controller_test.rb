...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { nombre: @asignatura.nombre, profesores_id: @asignatura.profesores_id } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { nombre: @asignatura.nombre, profesores_id: @asignatura.profesores_id } }
