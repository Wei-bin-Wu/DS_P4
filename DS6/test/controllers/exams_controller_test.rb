...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { date: @exam.date, name: @exam.name, subject_id: @exam.subject_id } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { date: @exam.date, name: @exam.name, subject_id: @exam.subject_id } }
