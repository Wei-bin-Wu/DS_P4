...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { apellido: @alumno.apellido, domicilio: @alumno.domicilio, email: @alumno.email, nombre: @alumno.nombre, num_tlf: @alumno.num_tlf, pass: @alumno.pass } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { apellido: @alumno.apellido, domicilio: @alumno.domicilio, email: @alumno.email, nombre: @alumno.nombre, num_tlf: @alumno.num_tlf, pass: @alumno.pass } }
