...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { apellido: @administrador.apellido, email: @administrador.email, nombre: @administrador.nombre, num_tlf: @administrador.num_tlf, pass: @administrador.pass } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { apellido: @administrador.apellido, email: @administrador.email, nombre: @administrador.nombre, num_tlf: @administrador.num_tlf, pass: @administrador.pass } }
